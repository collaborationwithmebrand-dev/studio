...
import { Palette, PlusCircle, Wallet, Ruler, TrendingUp, Trash2, PackageSearch, Search, DollarSign, ListOrdered, CheckCircle2, Truck, Sparkles, Loader2, Megaphone, Send, PhoneCall, Gift, MapPinned, XCircle } from 'lucide-react';
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {order.isForSomeoneElse && <Badge className="bg-pink-100 text-pink-600 text-[8px] font-black uppercase border-none h-4">GIFT ORDER</Badge>}
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-[10px] font-bold text-slate-500 flex items-center gap-2 mt-2 bg-white/50 p-2 rounded-xl">
                          <MapPinned className="w-3.5 h-3.5 text-blue-400 shrink-0" /> {order.deliveryAddress || "No address provided"}
                        </div>
