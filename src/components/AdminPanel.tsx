...
import { Palette, PlusCircle, Wallet, Ruler, TrendingUp, Trash2, PackageSearch, Search, DollarSign, ListOrdered, CheckCircle2, Clock, XCircle, Truck, Sparkles, Loader2, Megaphone, Send, Pin } from 'lucide-react';
...
export const AdminPanel: React.FC<AdminPanelProps> = ({ currentTheme, isAdmin }) => {
  ...
  const ordersQuery = useMemoFirebase(() => {
    // Crucial: Only request full catalog if user is definitively an admin in the database
